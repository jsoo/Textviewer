...
TextViewer is a simple web viewer for text files. To install it, upload it to a 
 web server. To use it, write documents in a simplified markup language such as 
 "Textile":http://textileit.com/ or 
 "Markdown":http://daringfireball.net/projects/markdown/, and drop them in 
 TextViewer. That's it -- you now have a website.
